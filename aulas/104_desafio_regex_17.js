(function(){
	...
	*/
	...
	var textMyName = text.replace(/Manuel Marques de Sousa/, 'Rafael Lima de Souza');

	console.log(textMyName);
	...
	*/
	...
	var textNaturalidade = text.replace(/brasileiro/, 'gaúcho');

	console.log(textNaturalidade);
	...
	*/
	...
	var textReplNums = text.replace(/\d/g, '-');

	console.log(textReplNums);
	...
	*/
	...
	var textToNum = text.replace(/[D-Hd-h]/g, 0);

	console.log( textToNum );
	...
	*/
	...
	// Como é a mesma letra, é interessante usar a flag i de ignore case
	var textTo4 = text.replace(/[a]/gi, 4);
	...
	*/
	...
	var textUpper = text.replace(/O Centauro de Luvas/g, function(phrase) {
